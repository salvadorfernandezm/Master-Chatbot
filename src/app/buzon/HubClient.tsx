...
export default function HubClient({ settings }: { settings: any }) {
  return (
    <div className="min-h-screen bg-slate-950 p-6 md:p-12 text-white font-sans flex flex-col items-center justify-center text-left">
      <div className="max-w-5xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <Link href="/buzon/registro" className="group">
            <div className="bg-slate-900 border-2 border-white/5 p-10 rounded-[3.5rem] hover:border-emerald-500/50 transition-all h-full shadow-2xl relative overflow-hidden">
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-8">Reporta fallos técnicos, inconformidades académicas o situaciones que requieran atención inmediata de las autoridades.</p>
        ...
        {/* ACCESOS DE GESTIÓN (PUNTO 1: BOTONES PARA AUTORIDADES) */}
