    ...
    <div className="flex flex-col h-screen bg-slate-50 relative font-sans">
      ...
      {isInfoOpen && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[100] flex items-center justify-center p-6">
          <div className="bg-white rounded-[2.5rem] p-8 max-w-sm w-full shadow-2xl border animate-in fade-in zoom-in duration-300">
            <div className="w-12 h-1.5 bg-slate-100 rounded-full mx-auto mb-6" />
            <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-emerald-600 mb-6 text-center underline underline-offset-8">Avisos Académicos</h3>
            ...
            <button 
              ...
              className="w-full py-4 bg-slate-900 text-white text-[11px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl active:scale-95 transition-all"
            >
              Entendido
            </button>
          </div>
