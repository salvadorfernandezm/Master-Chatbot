      ...
      <header className="border-b bg-white/90 backdrop-blur-md px-6 py-4 flex items-center justify-between sticky top-0 z-40 shadow-sm">
        ...
        {infoMessage && (
          <div className="flex items-center gap-2">
            <span className="hidden sm:block text-[9px] font-black text-lime-700 uppercase tracking-widest bg-lime-400 px-2 py-1 rounded-md animate-pulse">
              Avisos
            </span>
            <button 
              onClick={() => setIsInfoOpen(true)}
              className="h-10 w-10 rounded-full bg-lime-500 text-white flex items-center justify-center font-serif italic text-xl hover:bg-lime-600 transition-all shadow-lg active:scale-90 ring-4 ring-white"
            >
              i
            </button>
          </div>
