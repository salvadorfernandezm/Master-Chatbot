...
export default function ImpactoPage() {
  ...
  useEffect(() => {
    ...
    if (auth === "true") {
      setBackUrl("/admin/directora"); // Prioridad Directora
    } else if (session) {
      setBackUrl("/admin"); // Si no es dire pero eres tú
    }
  ...
  if (loading || !data) return <div className="min-h-screen bg-slate-950 flex items-center justify-center text-emerald-500 font-black animate-pulse">GENERANDO INFORME...</div>;
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 md:p-12 font-sans text-slate-900 text-left">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Mantenemos el resto del diseño igual... */}
        ...
        <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100">
            <h2 className="text-xl font-black uppercase mb-10 border-l-8 border-emerald-500 pl-4">Desempeño por Responsable</h2>
