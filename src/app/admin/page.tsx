...
export default async function AdminDashboard() {
  ...
  return (
    <div className="space-y-8">
      {/* Encabezado con Estado de Conexión y Respaldos */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        ...
        {/* Componente de Respaldo y Restauración */}
        <BackupControl />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-8 rounded-3xl text-white shadow-xl relative overflow-hidden group">
            ...
            <p className="text-indigo-100 mb-6 leading-relaxed">
                Tu proyecto está listo para ser insertado en Instructure Canvas usando los tokens únicos de cada Chatbot.
            </p>
            <Link href="/admin/chatbots" className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-3 rounded-xl font-bold hover:bg-white/20 transition-all inline-block text-sm">
