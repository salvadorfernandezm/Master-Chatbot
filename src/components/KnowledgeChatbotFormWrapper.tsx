...
import { createKnowledgeChatbot } from "@/app/actions/admin";

export default function KnowledgeChatbotFormWrapper() {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-200/50 border border-slate-100 h-fit lg:sticky lg:top-24">
      ...
      <form action={createKnowledgeChatbot} className={`${isOpen ? 'block' : 'hidden'} lg:block space-y-4`}>
        <div>
